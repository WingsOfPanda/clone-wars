...
# NEVER touches _consult/adjudicated.md (the Jedi general's resolution surface).
...
log_info "  the Jedi general: cp \"\$TOPIC_DIR/_consult/adjudicated-draft.md\" \"\$TOPIC_DIR/_consult/adjudicated.md\" then resolve PENDINGs."
