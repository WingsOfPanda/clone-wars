...
- [ ] v0.13.0 strict-dogfood pass on a real machine (release gate — `/clone-wars:spawn rex opencode dogfood-13` with permission=allow set; verify findings.md written, ack/done events emit clean JSONL, no ANSI bleed)
