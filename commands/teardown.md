...
3. Use the Bash tool to invoke teardown:

   ```
   "${CLAUDE_PLUGIN_ROOT}/bin/teardown.sh" --args-file "${CLONE_WARS_HOME:-$HOME/.clone-wars}/_args/teardown.txt"
   ```
