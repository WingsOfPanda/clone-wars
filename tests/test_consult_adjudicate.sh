...
# 3. Codex #4 fixture: existing adjudicated.md (the Jedi general's resolution) is NEVER touched.
cat > "$TD/_consult/adjudicated.md" <<'MD'
## Cross-verified
- [src/x.py:5] confirmed by both
## Adjudicated
- CONFIRMED: [src/y.py:10] verified by the Jedi general reading source
## Contested
## Not-verified
MD
...
assert_eq "$NEW" "$ORIGINAL" "the Jedi general's adjudicated.md preserved across re-adjudicate"
pass "adjudicate never overwrites the Jedi general's adjudicated.md (Codex #4 fixture)"
